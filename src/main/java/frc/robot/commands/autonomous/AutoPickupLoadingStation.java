...
public class AutoPickupLoadingStation extends DriveCommandBase {
   ...
   */
  public AutoPickupLoadingStation(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, LEDSubsystem leds, BooleanSupplier isFinished) {
  ...
  public void initialize() {
    ...
    SmartDashboard.putString("endPose", endPose.toString());
    SmartDashboard.putString("startPose", start.toString());

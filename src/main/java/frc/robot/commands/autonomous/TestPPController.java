...
public class TestPPController extends CommandBase {
  ...
  TestPPController::defaultLogError;
  ...
  public void execute() {
    ...
    String desiredPose = new Pose2d(desiredState.poseMeters.getTranslation(), desiredState.holonomicRotation).toString();

    SmartDashboard.putString("Desired Pose", desiredPose);
  ...
  public static void setLoggingCallbacks(
      ...
      BiConsumer<Translation2d, Rotation2d> logError) {
        TestPPController.logActiveTrajectory = logActiveTrajectory;
        TestPPController.logTargetPose = logTargetPose;
        TestPPController.logSetpoint = logSetpoint;
    TestPPController.logError = logError;
  }
}
